          ...
          <div class="product-details"><!--product-details-->
            <div class="col-sm-5">
              <div v-if="this.product.gallery.length" id="similar-product" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div v-for="(imageItem, index) in this.product.gallery" :key="index" :class="'item ' + (index == 0 ? 'active' : '')">
            ...
            <div class="col-sm-7">
              <div class="product-information"><!--/product-information-->
                ...
                <a href=""><img src="/images/product-details/share.png?93be8c&93be8c" class="share img-responsive"  alt="" /></a>
