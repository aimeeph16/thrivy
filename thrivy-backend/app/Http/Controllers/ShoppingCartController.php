...
class ShoppingCartController extends Controller
{
    ...
    //1. validates if there is a product_id and an amount
    //2. checking for the product and the product amount != 0 and product amount not lower than the incoming amount 
    //3. store cart data into db and decrement the product amount 
