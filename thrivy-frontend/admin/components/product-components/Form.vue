      ...
      <div class="card">
        ...
        <div class="card-body">
              ...
              <div class="row" v-if="this.$store.state.product.gallery.length">
                <!-- take note of :key -->
                <div class="col-lg-3" v-for="(record, index) of this.$store.state.product.gallery" :key="index">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div v-if="this.$store.state.product.features.length">
            <!-- take note of :key -->
            <div class="form-group" v-for="feature in this.$store.state.product.features" :key="feature.id">
