          ...
          <table class="table table-responsive table-bordered">
            ...
            <tbody>
              <template v-for="order in myOrders">
                ...
                <tr class="detail-row" v-if="order.show_details" :key="order.id">
                  <td colspan="7">
                    <div class="order-items">
                      <h4 style="color: #6a6a57">Products</h4>
                      <ul>
                        <li v-for="orderDetails in order.order_details" style="border-bottom: 1px solid #fff" :key="orderDetails.id">
